...
namespace cl { 
	...
	struct API vec2
	{
		...
		friend API vec2 operator+(vec2 left, const vec2& right);
		friend API vec2 operator-(vec2 left, const vec2& right);
		friend API vec2 operator*(vec2 left, const vec2& right);
		friend API vec2 operator/(vec2 left, const vec2& right);
			    
		friend API vec2 operator+(vec2 left, float32 value);
		friend API vec2 operator-(vec2 left, float32 value);
		friend API vec2 operator*(vec2 left, float32 value);
		friend API vec2 operator/(vec2 left, float32 value);
		...
		vec2& Lerp(const vec2& other, float32 t);
		static vec2 Lerp(const vec2& start, const vec2& end, float32 t);
	};
	...
	template<class T>
	inline tvec2<T>& tvec2<T>::Add(const tvec2<T>& other)
	{
		x += other.x;
		y += other.y;
	...
	template<class T>
	inline tvec2<T>& tvec2<T>::Subtract(const tvec2<T>& other)
	{
		x -= other.x;
		y -= other.y;
	...
	template<class T>
	inline tvec2<T>& tvec2<T>::Multiply(const tvec2<T>& other)
	{
		x *= other.x;
		y *= other.y;
	...
	template<class T>
	inline tvec2<T>& tvec2<T>::Divide(const tvec2<T>& other)
	{
		x /= other.x;
		y /= other.y;
	...
	template<class T>
	inline tvec2<T>& tvec2<T>::Add(T value)
	{
		x += value;
		y += value;
	...
	template<class T>
	inline tvec2<T>& tvec2<T>::Subtract(T value)
	{
		x -= value;
		y -= value;
	...
	template<class T>
	inline tvec2<T>& tvec2<T>::Multiply(T value)
	{
		x *= value;
		y *= value;
	...
	template<class T>
	inline tvec2<T>& tvec2<T>::Divide(T value)
	{
		x /= value;
		y /= value;
	...
	template<class T>
	inline tvec2<T>& tvec2<T>::operator+=(const tvec2<T>& other)
	{
		return Add(other);
	}
	...
	template<class T>
	inline tvec2<T>& tvec2<T>::operator+=(T value)
	{
		return Add(value);
	}
	...
	template <class T>
	inline API tvec2<T> operator+(tvec2<T> left, const tvec2<T>& right)
	{
	...
	template <class T>
	inline API tvec2<T> operator+(tvec2<T> left, T value)
	{
