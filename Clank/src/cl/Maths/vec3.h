...
namespace cl { 
	...
	struct API vec3
	{
		...
		vec3& Add(float32 other);
		vec3& Subtract(float32 other);
		vec3& Multiply(float32 other);
		vec3& Divide(float32 other);
		...
		static vec3 Lerp(const vec3& start, const vec3& end, float32 t);
	};
	...
	template<class T>
	inline tvec3<T>& tvec3<T>::Add(const tvec3<T>& other)
	{
		x += other.x;
		y += other.y;
		z += other.z;
	...
	template<class T>
	inline tvec3<T>& tvec3<T>::Subtract(const tvec3<T>& other)
	{
		x -= other.x;
		y -= other.y;
		z -= other.z;
	...
	template<class T>
	inline tvec3<T>& tvec3<T>::Multiply(const tvec3<T>& other)
	{
		x *= other.x;
		y *= other.y;
		z *= other.z;
	...
	template<class T>
	inline tvec3<T>& tvec3<T>::Divide(const tvec3<T>& other)
	{
		x /= other.x;
		y /= other.y;
		z /= other.z;
	...
	template<class T>
	inline tvec3<T>& tvec3<T>::Add(T value)
	{
		x += value;
		y += value;
		z += value;
	...
	template<class T>
	inline tvec3<T>& tvec3<T>::Subtract(T value)
	{
		x -= value;
		y -= value;
		z -= value;
	...
	template<class T>
	inline tvec3<T>& tvec3<T>::Multiply(T value)
	{
		x *= value;
		y *= value;
		z *= value;
	...
	template<class T>
	inline tvec3<T>& tvec3<T>::Divide(T value)
	{
		x /= value;
		y /= value;
		z /= value;
	...
	template<class T>
	inline bool tvec3<T>::operator==(const tvec3<T>& other) const
	{
	...
	template<class T>
	inline tvec3<T>& tvec3<T>::operator+=(const tvec3<T>& other)
	{
		return Add(other);
	}
	...
	template<class T>
	inline tvec3<T>& tvec3<T>::operator+=(T value)
	{
		return Add(value);
	}
	...
	template <class T>
	inline API tvec3<T> operator+(tvec3<T> left, const tvec3<T>& right)
	{
	...
	template <class T>
	inline API tvec3<T> operator+(tvec3<T> left, T value)
	{
